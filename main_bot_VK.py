...
def _map_row_to_payment_data(row_dict, vk_id, original_filename):
    ...
    # Map optional free-text comment if present in CSV with various common headers
    data['comment'] = pick(
        'Комментарий', 'комментарий', 'коммент', 'Comment', 'comment',
        'Примечание', 'примечание', 'Note', 'note', 'comments'
    )
